...
public class DatabaseResourcesBuildAction implements Action {
	    
    private final List<AcquiredResource> acquiredResources;

    public DatabaseResourcesBuildAction(List<AcquiredResource> acquiredResources) {
    ...
    public String getIconFileName() {
        ...
        return "/plugin/database-resources/images/24x24/database-icon.png";
    }
